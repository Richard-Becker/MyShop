...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "bonez.becker@gmail.com", ZipCode = "4399" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("bonez.becker@gmail.com", "Forms"), null);
